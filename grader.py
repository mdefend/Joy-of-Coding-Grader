...
class Grader:
    ...
    def extract_pdf_data(self,pdf_path):
        ...
        """temporary auto load"""
        self.config_path = self.config_path + "/intro_coding/assingment_1.json"
        pdf_base64 = None
        ...
        with open(pdf_path,"rb") as pdf:
              ...
              temp = self.api_call(PDF_PROMPT,content)
              return self.parse_grading_response(temp)
    ...
    def parse_grading_response(self, raw: str) -> dict:
        try:
            ...
            raise ValueError(f"Could not parse grading response: {raw}")
